    ...
    renderStep = (position) => {
      ...
      switch (this.getStepStatus(position)) {
        case STEP_STATUS.CURRENT: {
          ...
          indicatorLabelStyle = { backgroundColor: 'transparent', fontSize: this.customStyles.currentStepIndicatorLabelFontSize, color: this.customStyles.stepIndicatorLabelCurrentColor };
        ...
        case STEP_STATUS.FINISHED:{
          ...
          indicatorLabelStyle = { backgroundColor: 'transparent', fontSize: this.customStyles.stepIndicatorLabelFontSize, color: this.customStyles.stepIndicatorLabelFinishedColor };
          break;
        }
        ...
        case STEP_STATUS.UNFINISHED:{
          ...
          indicatorLabelStyle = {backgroundColor: 'transparent', overflow: 'hidden', fontSize: this.customStyles.stepIndicatorLabelFontSize, color: this.customStyles.stepIndicatorLabelUnFinishedColor };
          break;
        }
        default:
      }
      ...
      return (
        <Animated.View key={'step-indicator'} removeClippedSubviews style={[styles.step , stepStyle ]}>
          {_isArabic ?
            <Text style={indicatorLabelStyle}>{ stepCount - position }</Text> :
