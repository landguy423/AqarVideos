...
const icon_office = require('@common/assets/images/product_detail/flat.png');
const icon_office_select = require('@common/assets/images/product_detail/flat1.png');
...
const icon_factory = require('@common/assets/images/product_detail/floor.png');
const icon_factory_select = require('@common/assets/images/product_detail/floor1.png');
...
export const CATEGORY_ICON_LIST = {
  ...
  'building_select': icon_building_select,
  'villa': icon_villa,
  'villa_select': icon_villa_select,
  'apartment': icon_apartment,
  'apartment_select': icon_apartment_select,
  'office': icon_office,
  'office_select': icon_office_select,
  'chalet': icon_chalet,
  'chalet_select': icon_chalet_select,
  'apartment_owner': icon_apartment_owner,
  'apartment_owner_select': icon_apartment_owner_select,
  'factory': icon_factory,
  'factory_select': icon_factory_select,
  'firms': icon_firms,
  'firms_select': icon_firms_select,
  'office_for_sale': icon_office_for_sale,
  'office_for_sale_select': icon_office_for_sale_select,
  'store': icon_store,
  'store_select': icon_store_select,
  'gallery': icon_gallery,
  'gallery_select': icon_gallery_select,
  'land': icon_land,
  'land_select': icon_land_select,
  'esteraha': icon_esteraha,
  'esteraha_select': icon_esteraha_select,
}